...
const fetchRooms = async () => {
  const response = await fetch('http://http://104.131.181.50:8080/api/rooms'); // Ajuste para a URL correta do seu backend
  if (response.ok) {
...
const createRoomApi = async () => {
  const response = await fetch('http://http://104.131.181.50:8080/api/rooms', {
    method: 'POST',
    headers: {
